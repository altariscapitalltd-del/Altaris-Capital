...
import { z } from 'zod'
import { distributeNetworkCommission, refreshReferralProgress } from '@/lib/referrals'
...
export async function PATCH(req: NextRequest) {
  try {
    ...
    if (action === 'approve') {
      ...
      await refreshReferralProgress(tx.userId)
      await distributeNetworkCommission(tx.userId, tx.id, tx.amount)
