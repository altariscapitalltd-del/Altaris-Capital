        ...
        <div className="card" style={{ padding:32 }}>
          ...
          {step === 'form' ? (
            <form onSubmit={handleSignup}>
              ...
              {referralCode && <div style={{ background:'rgba(34,197,94,0.08)', border:'1px solid rgba(34,197,94,0.25)', borderRadius:8, padding:'12px 14px', marginBottom:16, color:'#86efac', fontSize:13 }}>Referral code applied: <strong>{referralCode}</strong></div>}
