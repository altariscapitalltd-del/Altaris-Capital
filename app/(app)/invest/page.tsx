...
const PLAN_CLASS_LOGOS: Record<string, string> = {
  Crypto: '/plan-icons/crypto.svg',
  DeFi: '/plan-icons/defi.svg',
  Stocks: '/plan-icons/stocks.svg',
  'Real Estate': '/plan-icons/real-estate.svg',
  Bonds: '/plan-icons/bonds.svg',
  Commodities: '/plan-icons/commodities.svg',
}
            ...
            return (
              <div key={plan.id} style={{ background:'var(--bg-card)', border:'1px solid var(--border)', borderRadius:16, padding:16, cursor:'pointer', transition:'all .15s' }}
                ...
                <div style={{ display:'flex', gap:12, alignItems:'flex-start' }}>
                  {/* Icon */}
                  <div style={{ width:46, height:46, borderRadius:13, background:plan.iconBg+'22', border:`1px solid ${plan.iconBg}33`, display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0, overflow:'hidden' }}>
                    <img src={PLAN_CLASS_LOGOS[plan.class] || '/plan-icons/crypto.svg'} alt={`${plan.class} plan`} style={{ width: 34, height: 34, objectFit: 'contain' }} />
                  </div>
        ...
        <div style={{ padding:'0 16px' }}>
          {userInvestments.length===0 ? (
            <div style={{ textAlign:'center', padding:'60px 20px' }}>
              <div style={{ fontSize:48, marginBottom:16 }}>Performance</div>
