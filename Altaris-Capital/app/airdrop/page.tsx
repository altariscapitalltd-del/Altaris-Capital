...
export default function AirdropPage() {
  const connectWallet = () => {
    alert('Wallet connect is handled in the airdrop flow.')
  }
      ...
      <div style={{ position: 'relative', zIndex: 1, padding: 24, maxWidth: 520, margin: '0 auto', minHeight: '100vh', display: 'grid', placeItems: 'center' }}>
        <div style={{ width: '100%' }}>
          ...
          <div style={{ padding: 22, borderRadius: 24, background: 'rgba(10,12,16,0.76)', border: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <button onClick={connectWallet} style={{ width: '100%', marginTop: 18, padding: '15px 16px', borderRadius: 14, border: 'none', background: '#F2BA0B', color: '#000', fontWeight: 900, cursor: 'pointer' }}>
              Connect Wallet
            </button>
